...
(function($){
function _2f(e){
var _30=$.data(e.data.target,"__draggable");
var _31=_30.options;
var _32=_30.proxy;
var _33=e.data;
...
function _35(e){
var _36=$.data(e.data.target,"__draggable");
var _37=_36.options;
var _38=_36.proxy;
if(!_38){
_38=$(e.data.target);
...
_3f(e);
var _45=$.data(e.data.target,"__draggable");
var _46=_45.proxy;
var _47=_45.options;
if(_47.revert){
if(_48()==true){
...
$.fn.__draggable=function(_4d,_4e){
if(typeof _4d=="string"){
return $.fn.__draggable.methods[_4d](this,_4e);
}
return this.each(function(){
var _4f;
var _50=$.data(this,"__draggable");
if(_50){
_50.handle.unbind(".__draggable");
_4f=$.extend(_50.options,_4d);
}else{
_4f=$.extend({},$.fn.__draggable.defaults,$.fn.__draggable.parseOptions(this),_4d||{});
}
var _51=_4f.handle?(typeof _4f.handle=="string"?$(_4f.handle,this):_4f.handle):$(this);
$.data(this,"__draggable",{options:_4f,handle:_51});
if(_4f.disabled){
$(this).css("cursor","");
return;
}
_51.unbind(".__draggable").bind("mousemove.__draggable",{target:this},function(e){
if($.fn.__draggable.isDragging){
return;
}
var _52=$.data(e.data.target,"__draggable").options;
if(_53(e)){
...
$.extend(e.data,_56);
var _57=$.data(e.data.target,"__draggable").options;
if(_57.onBeforeDrag.call(e.data.target,e)==false){
return;
}
$(document).bind("mousedown.__draggable",e.data,_39);
$(document).bind("mousemove.__draggable",e.data,_3f);
$(document).bind("mouseup.__draggable",e.data,_43);
...
function _53(e){
var _58=$.data(e.data.target,"__draggable");
var _59=_58.handle;
var _5a=$(_59).offset();
...
$.fn.__draggable.parseOptions=function(_5d){
var t=$(_5d);
...
(function($){
$.fn.__resizable=function(_6c,_6d){
if(typeof _6c=="string"){
return $.fn.__resizable.methods[_6c](this,_6d);
}
function _6e(e){
var _6f=e.data;
var _70=$.data(_6f.target,"__resizable").options;
...
return this.each(function(){
var _78=null;
var _79=$.data(this,"__resizable");
if(_79){
$(this).unbind(".__resizable");
_78=$.extend(_79.options,_6c||{});
}else{
_78=$.extend({},$.fn.__resizable.defaults,$.fn.__resizable.parseOptions(this),_6c||{});
$.data(this,"__resizable",{options:_78});
}
...
$(document).bind("mousedown.__resizable",_7c,_75);
$(document).bind("mousemove.__resizable",_7c,_76);
$(document).bind("mouseup.__resizable",_7c,_77);
...
$.fn.__resizable.parseOptions=function(_83){
var t=$(_83);
...
_285.window.__draggable({handle:">div.panel-header>div.panel-title",disabled:_285.options.__draggable==false,onStartDrag:function(e){
if(_285.mask){
...
_285.window.__resizable({disabled:_285.options.__resizable==false,onStartResize:function(e){
if(_285.pmask){
_285.pmask.remove();
}
...
return $.extend({},$.fn.panel.parseOptions(_290),$.parser.parseOptions(_290,[{__draggable:"boolean",__resizable:"boolean",shadow:"boolean",modal:"boolean",inline:"boolean"}]));
};
$.fn.window.defaults=$.extend({},$.fn.panel.defaults,{zIndex:9000,__draggable:true,__resizable:true,shadow:true,modal:false,inline:false,title:"New Window",collapsible:true,minimizable:true,maximizable:true,closable:true,closed:false});
})(jQuery);
(function($){
function _291(_292){
...
$.messager.defaults=$.extend({},$.fn.window.defaults,{ok:"Ok",cancel:"Cancel",width:300,height:"auto",modal:true,collapsible:false,minimizable:false,maximizable:false,__resizable:false,fn:function(){
}});
})(jQuery);
(function($){
...
_3a8.__resizable($.extend({},{handles:(_3a7[dir]||""),disabled:(!pp.panel("options").split),onStartResize:function(e){
_392=true;
...
_3d4.__resizable({disabled:(!_3d3)});
_393(_3d1);
};
...
var th=$(this);
var col=$.extend({},$.parser.parseOptions(this,["field","align","halign","order","width",{sortable:"boolean",checkbox:"boolean",__resizable:"boolean",fixed:"boolean"},{rowspan:"number",colspan:"number"}]),{title:(th.html()||undefined),hidden:(th.attr("hidden")?true:undefined),formatter:(th.attr("formatter")?eval(th.attr("formatter")):undefined),styler:(th.attr("styler")?eval(th.attr("styler")):undefined),sorter:(th.attr("sorter")?eval(th.attr("sorter")):undefined)});
...
_61a.each(function(){
$(this).__resizable({handles:_61d,disabled:($(this).attr("__resizable")?$(this).attr("__resizable")=="false":false),minWidth:25,onStartResize:function(e){
_617.resizing=true;
...
$.fn.propertygrid.defaults=$.extend({},$.fn.datagrid.defaults,{singleSelect:true,remoteSort:false,fitColumns:true,loadMsg:"",frozenColumns:[[{field:"f",width:16,__resizable:false}]],columns:[[{field:"name",title:"Name",width:100,sortable:true},{field:"value",title:"Value",width:100,__resizable:false}]],showGroup:false,groupView:_80e,groupField:"group",groupFormatter:function(_84b,rows){
return _84b;
}});
})(jQuery);
(function($){
...
_a8a.find("a.slider-handle").__draggable({axis:opts.mode,cursor:"pointer",disabled:opts.disabled,onDrag:function(e){
