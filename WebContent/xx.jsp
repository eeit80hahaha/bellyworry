			...
			<div>
				<div class="tabs">
					...
					<ul class="nav nav-tabs">
						<li class="active"><a href="#home" >日誌首頁</a></li>
						<li><a href="#profile" >今日紀錄</a></li>
						<li><a href="#settings" >歷史紀錄</a></li>
					</ul>
					<div class="tab-content" style="height: 100%; width: 100%;">
						<div class="tab-pane fade in active" id="home">
						<div style="border: 2px solid blue; width: 95%; height: 100%;">
						<div style="width: 74%; float: left; border: 2px solid red; height: 100%;">
						日誌全篇用
						</div>
						<div style="width: 25%; float: right; border: 2px solid yellow; height: 100%;">
						日期用
						</div>
						</div>
							<table border='1'>
...
<!-- 今日紀錄 -->
						...
						<!-- right div -->
						<div class="fade" id="profile" style="border: 2px solid blue; width: 95%; height: 100%; ">
							<form action="health.collection" method="post">
								<!-- left -->
								<div style="width: 40%; float: left; border: 2px solid red; height: 100%;" >
...
<!-- 歷史紀錄 -->			
						<div class="tab-pane fade" id="settings"  style="border: 2px solid yellow; width: 95%; height: 100%;">
