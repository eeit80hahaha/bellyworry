...
<body>
    ...
    <script src="${pageContext.request.contextPath}/backend/js/plugins/morris/raphael.min.js"></script>
    <script src="${pageContext.request.contextPath}/backend/js/plugins/morris/morris.min.js"></script>
    <script src="${pageContext.request.contextPath}/backend/js/plugins/morris/morris-data.js"></script>

    <!-- Flot Charts JavaScript -->
    <!--[if lte IE 8]><script src="js/excanvas.min.js"></script><![endif]-->
    <script src="${pageContext.request.contextPath}/backend/js/plugins/flot/jquery.flot.js"></script>
    <script src="${pageContext.request.contextPath}/backend/js/plugins/flot/jquery.flot.tooltip.min.js"></script>
    <script src="${pageContext.request.contextPath}/backend/js/plugins/flot/jquery.flot.resize.js"></script>
    <script src="${pageContext.request.contextPath}/backend/js/plugins/flot/jquery.flot.pie.js"></script>
    <script src="${pageContext.request.contextPath}/backend/js/plugins/flot/flot-data.js"></script>
