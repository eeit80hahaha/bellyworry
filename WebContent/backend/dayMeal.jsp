            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li>
                                <i class="fa fa-table"></i>查詢一日套餐
                            </li>
                            <li class="active">
                                <i class="fa fa-edit"></i> <a href="dayMealInsert.jsp">新增一日套餐</a>
                            </li>
                        </ol>
                    </div>
                </div>
...
<!-- 				</select> -->
			...
			<tr><th style="text-align:center;">一日套餐編號</th><th style="text-align:center;">一日套餐名稱</th><th style="text-align:center;">早餐</th><th style="text-align:center;">中餐</th><th style="text-align:center;">晚餐</th><th style="text-align:center;">修改</th><th style="text-align:center;">刪除</th></tr>
			</thead>
			<tbody>
			...
			<tr>
				<td>${vo.no}</td>
				<td>${vo.name}</td>
				<td>${vo.breakfastMealName.name}</td>
				<td>${vo.lunchMealName.name}</td>
				<td>${vo.dinnerMealName.name}</td>
