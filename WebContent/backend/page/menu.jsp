...
<%--             <a href="${pageContext.request.contextPath}/backend/foodCalInsert.jsp"><i class="fa fa-fw fa-desktop"></i>　菜色項目管理</a> --%>
        ...
        <li>
            <a href="${pageContext.request.contextPath}/backend/activitybase1.controller?pageNo=1"><i class="fa fa-fw fa-desktop"></i>　活動項目管理</a>
        </li>
        <li>
            <a href="${pageContext.request.contextPath}/backend/exambase1.controller?pageNo=1"><i class="fa fa-fw fa-desktop"></i>　小學堂項目管理</a>
        </li>
                 <li>
